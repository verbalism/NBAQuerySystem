...
public class MySpiderWebPlot extends SpiderWebPlot {
	...
	* @param maxValue
	*/
	public MySpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue){
		...
		* @param drawRing
		*/
	public MySpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing){
		...
		* @param drawRing
		*/
	public MySpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing, int ticks){
		...
		* @param drawRing
		*/
	public MySpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing, int ticks, String lablePrefix){
		...
		* @param drawRing
		*/
	public MySpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing, int ticks, String lablePrefix, String lableSuffix){
