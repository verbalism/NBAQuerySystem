...
public class RightHorizontalBarChart extends ChartPanel{
	public RightHorizontalBarChart(DefaultCategoryDataset dataset, String[] chartColor){
	...
	public static JFreeChart createChart(CategoryDataset dataset, String[] chartColor) {
		...
		chart.setBackgroundPaint(null);
		  ...
		  ((ValueAxis) rangeAxis).setUpperBound(130);
