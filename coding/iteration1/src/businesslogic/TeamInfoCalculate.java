...
public class TeamInfoCalculate {
	...
	public void writeTeamInfo(ArrayList<teamInfoVO> teaminfo){
		System.out.println("执行了writeTeamInfo");
		File f = new File("Data//teamInfoVO.txt");
		FileWriter fw ;
		BufferedWriter bw;
		/*try {
			fw=  new FileWriter(f);
	...
	public ArrayList<teamInfoVO> readTeamInfo(){
		File f = new File("Data//teamInfoVO.txt");
