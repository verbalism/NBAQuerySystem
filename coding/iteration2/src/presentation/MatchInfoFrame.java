...
public class MatchInfoFrame extends JFrame{
	...
	public MatchInfoFrame(MatchVO match){
    	...
    	team1Panel.setBounds(20, 250, frameWidth-60, 200);
    	team1Panel.setBackground(null);
		String[] columnNames = new String[]{"球员","位置","在场时间","投篮","三分","罚球","进攻/防守","篮板","助攻","抢断","盖帽","失误","犯规","得分"};
		ArrayList<MatchPlayer> players1 = match.getTeam1().getPlayers();
		Object[][]matchData=new Object[players1.size()][14];
		for(int i=0;i<players1.size();i++){
			...
			matchData[i][3] = players1.get(i).getFieldGoal()+"/"+players1.get(i).getFieldGoalAttempts();
			matchData[i][4] = players1.get(i).getThreePointShot()+"/"+players1.get(i).getThreePointAttempts();
			matchData[i][5] = players1.get(i).getFreeThrowGoal()+"/"+players1.get(i).getFreeThrowAttempts();
			matchData[i][6] = players1.get(i).getOffensiveRebound()+"/"+players1.get(i).getDefensiveRebound();
			matchData[i][7] = players1.get(i).getRebound();
			matchData[i][8] = players1.get(i).getAssist();
			matchData[i][9] = players1.get(i).getST();
			matchData[i][10] = players1.get(i).getBlockShot();
			matchData[i][11] = players1.get(i).getError();
			matchData[i][12] = players1.get(i).getFoul();
        ...
        TableColumn timeColumn1 = table1.getColumnModel().getColumn(2);
        timeColumn1.setPreferredWidth(70);
        timeColumn1.setMaxWidth(70);
        timeColumn1.setMinWidth(70);
        TableColumn backbordColumn1 = table1.getColumnModel().getColumn(6);
        backbordColumn1.setPreferredWidth(70);
		...
		Object[][]matchData2=new Object[players2.size()][14];
		for(int i=0;i<players2.size();i++){
			...
			matchData2[i][3] = players2.get(i).getFieldGoal()+"/"+players2.get(i).getFieldGoalAttempts();
			matchData2[i][4] = players2.get(i).getThreePointShot()+"/"+players2.get(i).getThreePointAttempts();
			matchData2[i][5] = players2.get(i).getFreeThrowGoal()+"/"+players2.get(i).getFreeThrowAttempts();
			matchData2[i][6] = players2.get(i).getOffensiveRebound()+"/"+players2.get(i).getDefensiveRebound();
			matchData2[i][7] = players2.get(i).getRebound();
			matchData2[i][8] = players2.get(i).getAssist();
			matchData2[i][9] = players2.get(i).getST();
			matchData2[i][10] = players2.get(i).getBlockShot();
			matchData2[i][11] = players2.get(i).getError();
			matchData2[i][12] = players2.get(i).getFoul();
			matchData2[i][13] = players2.get(i).getScore();
		}
        ...
        nameColumn2.setPreferredWidth(140);
        nameColumn2.setMaxWidth(140);
        nameColumn2.setMinWidth(140);
        TableColumn timeColumn2 = table2.getColumnModel().getColumn(2);
        timeColumn2.setPreferredWidth(70);
        timeColumn2.setMaxWidth(70);
        timeColumn2.setMinWidth(70);
        TableColumn backbordColumn2 = table2.getColumnModel().getColumn(6);
        backbordColumn2.setPreferredWidth(70);
