...
public class DateChooser extends JPanel{  
	   ...
	   private static final long serialVersionUID = 4529266044762990227L;  
	    ...
	    private void initPanel(){  
	        ...
	        monthPanel.setBorder(new LineBorder(new Color(69,69,69),1,false));
	    ...
	    private JLabel initLabel(){  
	        showDate=new JLabel("选择日期");
	        showDate.setHorizontalAlignment(SwingConstants.CENTER);
	        showDate.setFont(new Font("微软雅黑",0,14));
	        showDate.setBorder(null);
	        showDate.setForeground(Color.WHITE);
	        showDate.setBounds(0, 0, 200, 30);
	        ...
	        showDate.addMouseListener(new MouseAdapter(){  
	            ...
	            public void mouseExited(MouseEvent me){  
	                if(showDate.isEnabled()){  
	                    ...
	                    showDate.setForeground(new Color(149,149,149));  
	                }  
	            }  
	            public void mousePressed(MouseEvent me){  
	                if(showDate.isEnabled()){  
